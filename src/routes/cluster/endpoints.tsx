...
function EndpointsPage() {
  const { data: endpointHealth } = useSuspenseQuery(endpointHealthQueryOptions())
  const { data: endpointStatus } = useSuspenseQuery(endpointStatusQueryOptions())
                      ...
                      <tr key={ep.endpoint} className="hover:bg-muted/50">
                        <td className="px-6 py-3">
                          <div className="flex items-center gap-2">
                            ...
                            {isThisLeader && ep.endpoint.includes('10.0.1.1') && (
