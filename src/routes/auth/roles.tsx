...
import { addRole, deleteRole, grantPermission, revokePermission } from '@/lib/server/etcd'
...
function RolesPage() {
  ...
  const handlePermissionGranted = (roleName: string, permission: EtcdRolePermission) => {
  ...
  const handlePermissionRevoked = (roleName: string, permission: EtcdRolePermission) => {
      ...
      prev && prev.name === roleName
        ? {
            ...
            permissions: prev.permissions.filter(
              (p) => p.key !== permission.key || p.permType !== permission.permType
            ),
          }
        : prev
    )
  ...
  const openDialog = (role: EtcdRole, dialog: 'permissions' | 'grantPerm' | 'revokePerm' | 'delete') => {
                ...
                >
                  ...
                  <DropdownMenu>
                    ...
                    <DropdownMenuContent align="end">
                      <DropdownMenuItem onClick={() => openDialog(role, 'permissions')}>
                        View permissions
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => openDialog(role, 'grantPerm')}>
                        Grant permission
                      </DropdownMenuItem>
                      <DropdownMenuItem onClick={() => openDialog(role, 'revokePerm')}>
                        Revoke permission
                      </DropdownMenuItem>
                      {role.name !== 'root' && (
                        <DropdownMenuItem
