  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    if (!/^[a-zA-Z][a-zA-Z0-9_-]*$/.test(roleName.trim())) {
      toast.error("Invalid role name", {
        description: "Role name must start with a letter and contain only letters, numbers, hyphens, and underscores.",
      });
      return;
    }
    ...
    <Dialog open={open} onOpenChange={onOpenChange}>
      <DialogContent className="sm:max-w-md">
        <DialogHeader>
          ...
          <DialogDescription>
            Create a new role. You can grant permissions to the role after creation.
          </DialogDescription>
        </DialogHeader>
