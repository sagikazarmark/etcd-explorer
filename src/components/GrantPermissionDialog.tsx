...
interface GrantPermissionDialogProps {
  ...
  role: EtcdRole | null;
  onPermissionGranted: (roleName: string, permission: EtcdRolePermission) => void;
}
...
export function GrantPermissionDialog({
  ...
  const [permType, setPermType] = useState<"read" | "write" | "readwrite">("read");
      ...
      <DialogContent>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="space-y-2">
            ...
            <Select value={permType} onValueChange={(v) => setPermType(v as typeof permType)}>
              <SelectTrigger>
                <SelectValue />
              </SelectTrigger>
              <SelectContent>
